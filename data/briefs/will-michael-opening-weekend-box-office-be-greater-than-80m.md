# Candidate Analysis: will-michael-opening-weekend-box-office-be-greater-than-80m

**Question**: Will "Michael" Opening Weekend Box Office be greater than 80m?

**Category detected**: `crypto`
**Hours to resolution**: 211.7h  (end: 2026-04-27T12:00:00Z)
**Volume**: $8,808   Liquidity: $3,669
**Outcomes**: ['Yes', 'No']
**Best bid/ask**: 0.7 / 0.71   Mid: 0.705
**Favorite**: Yes @ 0.705
**Resolution source**: https://www.the-numbers.com/

## Layer 1: 量化 Edge
- Matched strategy: **Fav 0.70-0.88, vol $5-20k, ~7d out**
- Expected edge: **+6.10%** per bet
- Est. win rate: **82%**
- Favorite side: **Yes** @ ask **0.71**
