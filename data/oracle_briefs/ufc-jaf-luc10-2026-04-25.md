...
- **Question**: UFC Fight Night: Jafel Filho vs. Lucas Rocha (Flyweight, Prelims)
- **Slug**: `ufc-jaf-luc10-2026-04-25`
- **Category auto-detected**: `sports` (信不信由你自己判斷)
- **Outcomes**: `Jafel Filho` / `Lucas Rocha`
- **Current mid price**: 0.505  (ask 0.510, bid 0.500)
- **Spread**: 0.010
- **Volume**: $175,856
- **Liquidity (CLOB)**: $87,763
- **Hours to close**: 117.6
- **Resolution source**: https://www.ufc.com/events
- **End date**: 2026-04-26T03:59:59.999Z
- **Favorite side**: Jafel Filho @ 0.505
...
### Step 4: 計算 edge
- `p_market` = YES 邊的 ask 價（你若買 YES 必須吃 ask）= 0.510
- YES 邊 edge (bps) = (p_claude - 0.510) × 10000
- NO 邊 edge (bps) = ((1-p_claude) - 0.500) × 10000  (買 NO 吃 (1-bid))
