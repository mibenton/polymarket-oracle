...
- **Question**: Will the Fed decide differently in the next three decisions (Jan–Mar–Apr)?
- **Slug**: `will-the-fed-decide-differently-in-the-next-three-decisions-janmarapr`
- **Category auto-detected**: `politics_macro` (信不信由你自己判斷)
- **Outcomes**: `Yes` / `No`
- **Current mid price**: 0.004  (ask 0.004, bid 0.003)
- **Spread**: 0.001
- **Volume**: $278,341
- **Liquidity (CLOB)**: $36,090
- **Hours to close**: 185.6
- **Resolution source**: nan
- **End date**: 2026-04-29T00:00:00Z
- **Favorite side**: No @ 0.997
...
### Step 4: 計算 edge
- `p_market` = YES 邊的 ask 價（你若買 YES 必須吃 ask）= 0.004
- YES 邊 edge (bps) = (p_claude - 0.004) × 10000
- NO 邊 edge (bps) = ((1-p_claude) - 0.997) × 10000  (買 NO 吃 (1-bid))
